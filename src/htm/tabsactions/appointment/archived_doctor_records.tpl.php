...
?>
<table cellpadding="0" cellspacing="0" border="0" class="Appointment:Records display tablesorter tableViewer">
	<thead>
		<tr>
			<th>&nbsp;</th>
			<th>Reference</th>
...
<?php
	if(!empty($_oLoop)):
		...
		$oDoctor = $oUser->_selectFilterRecordsingle(sprintf(' AND t.id = %d',$_loop->parent2_id));
?>
		<tr class="<?= $class; ?>">
			<td><?= $_loop->id; ?></td>
