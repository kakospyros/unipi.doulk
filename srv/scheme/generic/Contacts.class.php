...
/**
 * @final Contacts_Exception Class - Exception class for follow class							*
 ...
 * @license																																					*
 *****************************************************************************************************/
final class Contacts_Exceptions extends \phpJar\Exceptions\PhpJar_Exception{}
/*****************************************************************************************************
 ...
 * @license																																					*
 *****************************************************************************************************/
class Contacts extends SchemeQueries
{
	...
	public function _deleteRecordsChildInclude($where = null, array $childList = array())
	{
		...
		{
			_pexceptions\Contact_Exceptions::throwException('contact child list deletion error');
		}
	}
	...
	public function _deleteRecordsNotInclude($where = null, array $childList = array())
	{
		...
		{
			_pexceptions\Contacts_Exceptions::throwException('Contacts list deletion error');
		}
	}
	...
	public function _insertMultiRecords($parent_id, array $childList )
	{
		...
		{
			_pexceptions\Contacts_Exceptions::throwException('Contacts list is empty for insertion on link table');
		}
	}
